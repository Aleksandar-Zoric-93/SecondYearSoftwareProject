...
namespace SoftwareProject
{
    public partial class ViewSales : Form
    {
        ...
        {
            RegisterStaff nf = new RegisterStaff(Parent);
        ...
        private void showPayBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand("SELECT * FROM Payments WHERE payDate = '" + dateViewTxt.Text + "'", conn);
                ...
                grdSales.DataSource = ds.Tables["ss"];
