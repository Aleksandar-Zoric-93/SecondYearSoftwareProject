...
namespace SoftwareProject
{
    public partial class ListFood1 : Form
    {
        ...
        private void ListFood1_Load(object sender, EventArgs e)
        {
        ...
        private void sortStockNoBtn_Click(object sender, EventArgs e)
        {
            //Define the connection string(hostname,userID,password
            string AlexDB = "Data Source=Oracle;User Id=t00166011;Password=4yybapkv;";
            try
            {
                ...
                //Creating an instance of an Oracle Command to be executed on the connection
                OracleCommand cmd = new OracleCommand("SELECT * FROM Stock ORDER BY StockNo", conn);
